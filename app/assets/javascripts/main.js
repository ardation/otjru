...
var Router = Backbone.Router.extend({
  ...
  step2: function(hash) {
    ...
    index.render(function(el) {
      route.stepTransition(el , "#step2", function() {
        ...
        if( navigator.onLine && googlemap != undefined ) {
          $( "#map_canvas" ).show();
          ...
          googlemap.addMapToCanvas( mapCanvas, myOptions, 55.781379,37.622375);
  ...
  step6a: function(hash) {
    var route = this;
    var index = new Index.Views.step6a;
    index.render(function(el) {
      route.stepTransition(el , "#step6a", function() {
        index.populate();
      });
    });
  },
  step6b: function(hash) {
    var route = this;
    var index = new Index.Views.step6b;
    index.render(function(el) {
      route.stepTransition(el , "#step6b", function() {
        index.populate();
      });
    });
  },
  details: function(hash) {
    var route = this;
    var index = new Index.Views.details;
    index.render(function(el) {
      route.stepTransition(el , "#details", function() {
